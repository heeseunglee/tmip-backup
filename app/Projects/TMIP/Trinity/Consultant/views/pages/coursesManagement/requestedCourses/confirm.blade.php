                                ...
                                <div class="col-sm-12">
                                    ...
                                    <div class="col-sm-9">
                                        <div class="alert alert-warning">
                                            <i class="fa fa-check-square-o"></i> 해당 인사담당자와 유선 통화후 승인을 진행해 주시기 바랍니다.
                                        </div>
                                        <div class="box-body">
                                            <div class="row">
                                                    ...
                                                    <table class="table">
                                                        ...
                                                        <tr>
                                                            <?php
                                                                ...
                                                                foreach(explode(',', $requested_course->running_days) as $running_day) {
                                                                    $running_days_array[] = $days_array[$running_day];
                                                                }
                                                            ?>
                                                            <td>수강 요일</td>
                                                            <td>
