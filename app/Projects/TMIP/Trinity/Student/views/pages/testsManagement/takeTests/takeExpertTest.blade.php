...
@section('main_content')
    <section>
        ...
        <div class="section-header">
            <h3 class="text-standard"><i class="fa fa-fw fa-arrow-circle-right text-gray-light"></i> 테스트 진행 <small>고급편</small></h3>
        </div>
                ...
                <div class="col-sm-12">
                    <div class="box">
                        <div class="box-head style-primary">
                            <header><h4 class="text-light">테스트 진행 - 고급 - ::: 남은 시간 : <strong id="countdown"></strong></h4></header>
                        </div>
                        <div class="box-body">
                            {{ Form::open() }}
