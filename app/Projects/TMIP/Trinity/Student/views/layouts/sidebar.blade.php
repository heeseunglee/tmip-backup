<ul class="main-menu">
    ...
    <li @if(strpos($current_url, 'testsManagement')) class = "active expanded" @endif>
        ...
        <ul>
            <li><a href="{{ URL::route('Trinity.Student.testsManagement.takeTests.index') }}"
                @if(strpos($current_url, 'testsManagement/takeTest/index')) class = "active" @endif>테스트 진행</a></li>
