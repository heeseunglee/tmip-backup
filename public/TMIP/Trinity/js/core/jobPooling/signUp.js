...
$(document).ready(function() {
    ...
    $("#available_time_afternoon_checkbox").click(function(e) {
        if($("#available_time_afternoon_checkbox").is(":checked")) {
            $("#available_time_afternoon_start").removeAttr("disabled").attr("required", "required");
            $("#available_time_afternoon_end").removeAttr("disabled").attr("required", "required");
        }
        else {
    ...
    $("#available_time_night_checkbox").click(function(e) {
        if($("#available_time_night_checkbox").is(":checked")) {
            $("#available_time_night_start").removeAttr("disabled").attr("required", "required");
            $("#available_time_night_end").removeAttr("disabled").attr("required", "required");
        }
        else {
